...
@section('content')
                ...
                <div class="card-body">
                    <div class="row">
                        @foreach($experiences as $experience)
                                ...
                                <div class="bg-light border-primary border-3 border-start shadow-sm p-3">
                                    ...
                                    <div class="">
                                        <a href="" class="text-black-50 fs-6 d-flex flex-column">
                                            <span>{{ $experience->career_field }}</span>
                            ...
                            <!-- Modal Delete -->
                            @include('web.seeker.modals.experience.delete')
                            <!-- Modal Update -->
                            @include('web.seeker.modals.experience.update')
                        @endforeach
                    </div>
                </div>
            </div>
    ...
    <!-- Modal create -->
   @include('web.seeker.modals.experience.create')
