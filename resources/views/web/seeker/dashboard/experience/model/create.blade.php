            ...
            <div class="modal-body">
                <form action="{{ route('seeker.experiences.store') }}" method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                        ...
                        <input name="company_name" value="{{ old('company_name') }}" type="text" class="form-control @error('company_name') is-invalid @enderror rounded-pill" id="company_name" placeholder="Company Name">
